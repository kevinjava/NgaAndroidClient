 ...
 * <li>{@link cn.trinea.android.common.util.DownloadManagerPro.RequestPro#setNotiClass(String)} set noti class</li>
 * <li>{@link cn.trinea.android.common.util.DownloadManagerPro.RequestPro#setNotiExtras(String)} set noti extras</li>
 * </ul>
 * 
...
public class DownloadManagerPro {
     ...
     * @param downloadId
     * @return <ul>
     * <li>if status of downloadId is {@link android.app.DownloadManager#STATUS_PAUSED}, return {@link #getPausedReason(long)}</li>
