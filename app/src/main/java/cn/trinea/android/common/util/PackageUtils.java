 ...
 * <li>{@link cn.trinea.android.common.util.PackageUtils#installNormal(android.content.Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#installSilent(android.content.Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#install(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstallNormal(android.content.Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstallSilent(android.content.Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#uninstall(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(android.content.Context)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(android.content.Context, String)}</li>
 * <li>{@link cn.trinea.android.common.util.PackageUtils#isSystemApplication(android.content.pm.PackageManager, String)}</li>
 * </ul>
 * 
...
public class PackageUtils {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link cn.trinea.android.common.util.PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     * {@link cn.trinea.android.common.util.PackageUtils}.INSTALL_FAILED_*. same to {@link android.content.pm.PackageManager}.INSTALL_*
     */
